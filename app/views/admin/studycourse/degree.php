...
<table class="default collapsable">
    ...
    <tr class="steel">
        ...
        <td><? if ($studydegree['count_user'] == 0): ?><a href="<?=$controller->url_for('admin/studycourse/delete_degree')?>?deg_id=<?= $studydegree['abschluss_id'] ?>"><?= Assets::img('icons/16/blue/trash.png', array('title' => 'Abschluss löschen')) ?></a><? endif; ?></td>
    </tr>
