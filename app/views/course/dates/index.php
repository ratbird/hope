...
<table class="default">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="<?= URLHelper::getLink("dispatch.php/course/dates/details/".$date->getId()) ?>" rel="lightbox"><?= htmlReady($GLOBALS['TERMIN_TYP'][$date['date_typ']]['name']) ?></a></td>
            <td>
                <a href="<?= URLHelper::getLink("dispatch.php/course/dates/details/".$date->getId()) ?>" rel="lightbox">
