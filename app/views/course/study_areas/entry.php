...
?>
<?= Assets::input("icons/16/blue/accept.png", array('type' => "image", 'class' => "study_area_selection_add_".$id, 'data-id' => "'".$id."'", 'data-course_id' => "'".htmlReady($course_id)."'", 'name' => "study_area_selection[add][".$id."]", 'style' => !$area->isAssignable() || $selection->includes($area)? "visibility:hidden;" : "", 'title' => _('Diesen Studienbereich zuordnen'))) ?>
