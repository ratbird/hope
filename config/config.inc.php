...
$UNI_INFO = "Stud.IP 2.3 - Studienbegleitender Internetsupport von Präsenzlehre";
...
*/
$SEM_TYPE_MISC_NAME=_("sonstige"); //this name is replaced by the common name (=course)
...
$SEM_TYPE[8]=array("name"=>_("Gremium"), "class"=>2, "title_dozent" => array(_("LeiterIn"), _("LeiterInnen")), "title_tutor" => array(_("Mitglied"), _("Mitglieder")));
$SEM_TYPE[9]=array("name"=>_("Projektgruppe"), "class"=>2, "title_dozent" => array(_("LeiterIn"), _("LeiterInnen")), "title_tutor" => array(_("Mitglied"), _("Mitglieder")));
...
$UPLOAD_TYPES=array(    "default" =>
                array(  "type"=>"deny",
                        "file_types" => array ("rtf", "xls", "ppt", "zip", "pdf", "txt", "tgz", "gz", "bz2"),
...
$export_icon["xslt"] = "icons/16/blue/file-generic.png";
$export_icon["xsl"] = "icons/16/blue/file-generic.png";
$export_icon["rtf"] = "icons/16/blue/file-text.png";
$export_icon["fo"] = "icons/16/blue/file-generic.png";
