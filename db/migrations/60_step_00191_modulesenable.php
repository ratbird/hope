...
class Step00191ModulesEnable extends Migration
{
    ...
    function up()
    {
        ...
        $db->exec("INSERT IGNORE INTO `config` ( `config_id` , `parent_id` , `field` , `value` , `is_default` , `type` , `range` , `section` , `position` , `mkdate` , `chdate` , `description` , `comment` , `message_template` ) VALUES ( MD5('STM_ENABLE'), '', 'STM_ENABLE', '0', '0', 'boolean', 'global', 'modules', '0', '".time()."', '".time()."', 'Schaltet ein oder aus, ob die Studienmodule global verfügbar sind.', '', '')");
        ...
        $db->exec("INSERT IGNORE INTO `config` ( `config_id` , `parent_id` , `field` , `value` , `is_default` , `type` , `range` , `section` , `position` , `mkdate` , `chdate` , `description` , `comment` , `message_template` ) VALUES ( MD5('BANNER_ADS_ENABLE'), '', 'BANNER_ADS_ENABLE', '0', '0', 'boolean', 'global', 'modules', '0', '".time()."', '".time()."', 'Schaltet ein oder aus, ob die Bannerwerbung global verfügbar ist. You need an additional folder in the pictures folder named banner. The Webserver needs write accees for this folder.', '', '')");
