...
class Tic1207Config extends Migration
{
    ...
    function up()
    {
        ...
        $db->exec("UPDATE config SET section = 'global' WHERE field IN ('ADMISSION_ALLOW_DISABLE_WAITLIST','ADMISSION_PRELIM_COMMENT_ENABLE','DOCUMENTS_EMBEDD_FLASH_MOVIES','EMAIL_DOMAIN_RESTRICTION','ENABLE_PROTECTED_DOWNLOAD_RESTRICTION','EXTERNAL_FLASH_MOVIE_EMBEDDING','EXTERNAL_HELP','EXTERNAL_HELP_LOCATIONID','EXTERNAL_HELP_URL','EXTERNAL_IMAGE_EMBEDDING','HTML_HEAD_TITLE','MAIL_NOTIFICATION_ENABLE','MAINTENANCE_MODE_ENABLE','NEWS_DISABLE_GARBAGE_COLLECT','NEWS_RSS_EXPORT_ENABLE','ONLINE_NAME_FORMAT','SEMESTER_TIME_SWITCH','SEM_TREE_ALLOW_BRANCH_ASSIGN','SENDFILE_LINK_MODE','WANTED_DEFAULT_VALUES','ZIP_DOWNLOAD_MAX_FILES','ZIP_DOWNLOAD_MAX_SIZE','ZIP_UPLOAD_ENABLE','ZIP_UPLOAD_MAX_DIRS','ZIP_UPLOAD_MAX_FILES')");
        $db->exec("UPDATE config SET section = 'evaluation' WHERE field IN ('EVAL_AUSWERTUNG_CONFIG_ENABLE','EVAL_AUSWERTUNG_GRAPH_FORMAT')");
        $db->exec("UPDATE config SET section = 'archiv' WHERE field IN ('AUTO_ARCHIVIERUNG','AUTO_ARCHIVIERUNG_LETZTE_AKTIVITÄT','AUTO_ARCHIVIERUNG_SEMESTER')");
