...
if (!empty($result)) {
    ...
    echo "<th width=\"2%\"><input type=\"checkbox\" id=\"checkAll\" name=\"all\" value=\"1\" 
        checked=\"checked\" aria-label=\"Alle auswählen\" data-proxyfor=\":checkbox[name^=sem]\"/></th>\n</tr>\n";
    // Studip 2.4
    #echo "<th width=\"2%\"><input type=\"checkbox\" name=\"all\" value=\"1\" checked=\"checked\" aria-label=\"Alle auswählen\" data-proxyfor=\":checkbox[name^=sem]\"/></th>\n</tr>\n";
...
// Dummy-Wert damit $sem auch ohne ausgewaehlte Seminare ausgewertet wird
    ...
    echo "\n<tr>\n";
    echo "<td valign=\"top\">";
    echo MessageBox::info('In dem ausgewählten Semester sind keine Veranstaltungen hinterlegt');
    echo "</td>";
    echo "</tr>";
    echo "</table>";
}
