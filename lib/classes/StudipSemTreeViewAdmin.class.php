    ...
    */
    ...
    function getItemContent($item_id){
        ...
        if ($item_id == $this->move_item_id){
            $this->msg[$item_id] = "info§" . sprintf(_("Dieses Element wurde zum Verschieben / Kopieren markiert. Bitte w&auml;hlen sie ein Einfügesymbol %s aus, um das Element zu verschieben / kopieren."), "<img src=\"".Assets::image_path('icons/16/yellow/arr2_right.png')." " .tooltip(_("Einfügesymbol")) . ">");
        }
