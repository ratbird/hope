...
define ("EVAL_PIC_MOVE_GROUP",    Assets::image_path('icons/16/yello/arr_2left.png'));
define ("EVAL_PIC_MOVE_UP",    Assets::image_path('icons/16/yello/arr_2up.png'));
define ("EVAL_PIC_MOVE_DOWN",  Assets::image_path('icons/16/yello/arr_2down.png'));
define ("EVAL_PIC_MOVE_RIGHT", Assets::image_path('icons/16/yello/arr_2right.png'));
