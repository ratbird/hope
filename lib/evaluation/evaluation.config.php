...
define ("EVAL_PIC_ARROW_ACTIVE", Assets::image_path('forumgruenrunt.gif'));
...
define ("EVAL_PIC_MOVE_DOWN",  Assets::image_path('icons/16/yello/arr2_down.png'));
define ("EVAL_PIC_MOVE_RIGHT", Assets::image_path('icons/16/yello/arr2_right.png'));
define ("EVAL_PIC_MOVE_LEFT", Assets::image_path('icons/16/yello/arr2_left.png'));
...
define ("EVAL_PIC_TIME",       Assets::image_path('icon-uhr.gif'));
define ("EVAL_PIC_EXCLAIM",    Assets::image_path('icon-news.gif'));
...
define ("EVAL_PIC_BACK",    Assets::image_path('link_intern.gif'));
...
define ("EVAL_PIC_ARROW_NEW", Assets::image_path('forumgelb.gif'));
define ("EVAL_PIC_ARROW_NEW_OPEN", Assets::image_path('forumgelbrunt.gif'));
define ("EVAL_PIC_ARROW_RUNNING", Assets::image_path('forumgruen.gif'));
define ("EVAL_PIC_ARROW_RUNNING_OPEN", Assets::image_path('forumgruenrunt.gif'));
