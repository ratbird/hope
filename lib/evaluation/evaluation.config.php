...
define ("EVAL_PIC_ADD",    PATH_PICTURES."icons/16/blue/plus.png");
define ("EVAL_PIC_ADD_TEMPLATE", PATH_PICTURES."icons/16/blue/plus.png");
define ("EVAL_PIC_REMOVE",    PATH_PICTURES."icons/16/blue/trash.png");
define ("EVAL_PIC_EDIT",    PATH_PICTURES."icons/16/blue/edit.png");
define ("EVAL_PIC_BACK",    PATH_PICTURES."link_intern.gif");
define ("EVAL_PIC_ARROW_TEMPLATE", PATH_PICTURES."icons/16/blue/arr_1right.png");
define ("EVAL_PIC_ARROW_TEMPLATE_OPEN", PATH_PICTURES."icons/16/blue/arr_1down.png");
...
define ("EVAL_PIC_ARROW_STOPPED", PATH_PICTURES."images/icons/16/red/arr_1right.png");
define ("EVAL_PIC_ARROW_STOPPED_OPEN", PATH_PICTURES."images/icons/16/red/arr_1down.png");
define ("EVAL_PIC_TREE_ARROW", PATH_PICTURES."icons/16/blue/arr_1right.png");
define ("EVAL_PIC_TREE_ARROW_ACTIVE", PATH_PICTURES."icons/16/blue/arr_1down.png");
