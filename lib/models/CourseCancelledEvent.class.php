...
class CourseCancelledEvent extends CourseEvent
{
    ...
    protected static function configure($config)
    {
        ...
        $config['additional_fields']['editor_id'] = function ($date){
            return null;
        };
        $config['additional_fields']['uid'] = function ($date){
            return 'Stud.IP-SEM-' . $date->getId()
                    . '@' . $_SERVER['SERVER_NAME'];
        };
        $config['additional_fields']['summary'] = function ($date){
            return $date->course->name;
        };
        $config['additional_fields']['description'] = function ($date){
            return '';
        };
        $config['additional_fields']['location'] = function ($date){
            $date->getRoomName();
        };
    }
