...
Copyright (C) 2005-2007 Till Glˆggler <tgloeggl@uos.de>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
            ...
            <? if ($openAll) { ?>
                <tr>
                    <td class="table_row_odd" colspan="6" align="center" height="30" valign="middle">
                        ...
                        <?= Button::create(_('Alles ¸bernehmen'), 'editAll') ?>
                        &nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    ...
                    <td class="table_row_even" colspan="2" align="left" nowrap="nowrap">
                        <font size="-1">
                            <? if ($modules['forum']) : ?>
                            <input type="checkbox" name="createAllForumFolders"> <?=_("F¸r alle Termine einen Forumsordner anlegen")?>
                            <br>
                            <? endif;   if ($modules['documents']) : ?>
                            <input type="checkbox" name="createAllFileFolders"> <?=_("F¸r alle Termine einen Dateiordner anlegen")?>
                            <? endif; ?>
                        </font>
                    </td>
                </tr>
            <? } ?>
                ...
                foreach ($termine as $singledate_id => $singledate) {
                    ...
                    $tpl['calendar'] .= Assets::img('icons/16/blue/schedule.png',
                                                    tooltip2(sprintf(_('Zum %s in den persˆnlichen Terminkalender springen'),
        ...
        <?
            ...
            // fill attributes
            $infobox_template->set_attribute('picture', 'sidebar/date-sidebar.png');
