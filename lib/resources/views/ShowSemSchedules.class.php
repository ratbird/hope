        ...
        <table border=0 celpadding=2 cellspacing=0 width="99%" align="center">
            <tr>
                ...
                <td class="<? echo $cssSw->getClass() ?>"  width="10%" align="left">&nbsp;
                    <a href="<? echo $PHP_SELF ?>?quick_view=<?=$this->used_view?>&quick_view_mode=<?=$view_mode?>&previous_sem=1"><img class="middle" src="<?= Assets::image_path('icons/16/darkblue/arr_2left.png') ?>" <? echo tooltip (_("Vorheriges Semester anzeigen")) ?>border="0"></a>
                </td>
                ...
                <td class="<? echo $cssSw->getClass() ?>" width="10%" align="center">&nbsp;
                    <a href="<? echo $PHP_SELF ?>?quick_view=<?=$this->used_view?>&quick_view_mode=<?=$view_mode?>&next_sem=1"><img class="middle" src="<?= Assets::image_path('icons/16/darkblue/arr_2right.png') ?>" <? echo tooltip (_("Nächstes Semester anzeigen")) ?>border="0"></a>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="<? echo $cssSw->getClass() ?>" width="4%" align="center" valign="bottom">&nbsp;
                    <?
                    if ((!$resources_data["schedule_time_range"]) || ($resources_data["schedule_time_range"] == -1))
                        printf ("<a href=\"%s?quick_view=%s&quick_view_mode=%s&time_range=%s\"><img src=\"" . Assets::image_path('icons/16/darkblue/arr_2down.png') . "\" %s></a>", $PHP_SELF, $this->used_view, $view_mode, ($resources_data["schedule_time_range"]) ? "FALSE" : 1, tooltip (_("Spätere Belegungen anzeigen")));
                    ?>
                </td>
