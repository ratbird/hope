...
<table class="default select">
    <tbody>
        <tr>
            <th colspan="5">
                <h3><?= _("Filter") ?></h3>
                <p class="info"><?= _("Grenze den obigen Pool an Postings ein mit Filtermöglichkeiten") ?></p>
            </th>
        </tr>
        <tr>
    ...
    array("kategorie" => _("Informationen"),
        ...
        array(
            array(
                ...
                "text" => _("Wenn man Blubber viel nutzt, kann der globale Blubberstream leicht mal unübersichtlich werden. Erstellen Sie einfach individuelle Blubberstreams. Beispielsweise alle privaten Postings Ihrer Buddies oder alle Postings mit gewissen Hashtags wie #opensource und #mathematik.")
            ),
            array(
