...
class ScheduleWidget extends StudIPPlugin implements PortalPlugin
{
  ...
  /**
    ...
    /**
     * Bereitet alle eingehenden Optionen vor um die CalendarView erzeugen zu können.
     */
    ...
    function addEntry_action( $id = false )
    {
        ...
        if ($error) {
            ...
            $return['error_message'] = _("Eintrag konnte nicht gespeichert werden, da die Start- und/oder Endzeit ungültig ist!");
        } else {
