            ...
            <table width="100%" border="0" cellpadding="2" cellspacing="1" align="center" class="steelgroup0">
                ...
                <? while ($calendar = $group_calendar->nextCalendar()) : ?>
                    ...
                    <tr>
                        ...
                        <? if (sizeof($js_events)) : ?>
                            <td width="<?= $width1 ?>%" class="lightmonth" align="right" style="background-image: url('<?= Assets::image_path('calendar/category5_small.jpg') ?>');">
                        <? else : ?>
                        ...
                        for ($i = $start + $calendar->view->getStart(); $i < $end + $calendar->view->getStart(); $i += $step_day) :
                            ...
                            <? if (sizeof($js_events)) : ?>
                                <td width="<?= $width1 ?>%" align="right" style="background-image: url('<?= Assets::image_path('calendar/category5_small.jpg') ?>');">
                            <? else: ?>
