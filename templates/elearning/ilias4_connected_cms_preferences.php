...
<table>
    <tbody>
        ...
        <tr>
            ...
            &nbsp; <?=Assets::img('info.gif', tooltip(_("Geben Sie hier den Namen einer bestehenden ILIAS 4 - Kategorie ein, in der die Lernmodule und User-Kategorien abgelegt werden sollen."), TRUE, TRUE))?>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr>
            ...
            &nbsp; <?=Assets::img('info.gif', tooltip(_("Geben Sie den Namen des Rollen-Templates ein, das für die persönliche Kategorie von DozentInnen verwendet werden soll (z.B. \"Author\")."), TRUE, TRUE))?>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr>
            ...
            <?=Assets::img('info.gif', tooltip(_("Wählen Sie diese Option, wenn die ILIAS-Passwörter der zugeordneten Accounts verschlüsselt in der Stud.IP-Datenbank abgelegt werden sollen."), TRUE, TRUE))?>
            </td>
        </tr>
        <tr>
            <td colspan="2">&nbsp;</td>
        ...
        <tr>
            ...
            if ($ldap_options) {
                ...
                echo Assets::img('info.gif', tooltip(_("Wählen Sie hier ein Authentifizierungsplugin, damit neu angelegte ILIAS-Accounts den Authentifizierungsmodus LDAP erhalten, wenn dieser Modus auch für den vorhandenen Stud.IP-Account gilt. Andernfalls erhalten alle ILIAS-Accounts den default-Modus"), TRUE, TRUE));
            } else {
