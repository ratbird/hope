                            ...
                            <table cellpadding="2" cellspacing="0" border="0">
                                <tr class="table_row_even">
                                    ...
                                    <td class="table_row_even" style="text-align: right;">
                                        <input type="text" name="suchbegriff" id="suchbegriff" value="<?= htmlReady(Request::get('suchbegriff')) ?>">
                                    </td>
                                </tr>
                                <tr class="table_row_even">
                                    <td style="font-weight: bold;">
                                    ...
                                    <td>
                                        <input type="text" name="author" id="author" value="<?= htmlReady(Request::get('author')) ?>">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="table_row_odd" align="center" colspan="2">
