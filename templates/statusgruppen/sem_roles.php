...
<tr>
    ...
    <th width="5%" align="right" colspan="3" nowrap>
        ...
        <? if ($role['role']->getSelfAssign()) :
            echo Icon::create('person', 'inactive', ['title' => _("Personen können sich dieser Gruppe selbst zuordnen")])->asImg();
        endif; ?>
        <?= $mp; ?>
...
<tr>
    ...
    <td width="1%" align="right">
        ...
        <?= Icon::create('trash', 'clickable', ['title' => _("Gruppenzuordnung für diese Person aufheben")])->asImg() ?>
        </a>
    </td>
</tr>
<? endforeach; ?>
