...
<head>
    ...
    <link href="assets.php?stylesheets/style.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <script type="text/javascript" src="assets.php?javascripts/jquery/jquery-1.7.js"></script>
